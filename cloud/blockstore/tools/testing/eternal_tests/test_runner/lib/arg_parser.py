...
from .test_configs import get_description_test_case
...
class ParseHelper:
    ...
    def parse_command(self):
        parser = argparse.ArgumentParser(description='Examples:' +
                                                     '\n\t./yc-nbs-run-eternal-load-tests setup-test --cluster <cluster> --cluster-config-path <config-path> --test-case eternal-640gb-verify-checkpoint --no-generate-ycp-config --zone-id a',
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            help='specify the test case or <all>, if you want to manage all test-cases' + get_description_test_case())
